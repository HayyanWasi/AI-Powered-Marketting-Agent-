...
**Primary Dependencies**: FastAPI, Pillow, Pydantic v2, Supabase Python SDK  
**Storage**: N/A - Validation creates results, doesn't persist data to database  
**Testing**: pytest with coverage plugin  
**Target Platform**: Linux server (part of AI Social Campaign Manager backend)
