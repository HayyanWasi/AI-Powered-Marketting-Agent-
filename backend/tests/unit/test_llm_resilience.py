...
def test_groq_429_failover():
    ...
    service._ordered_chain = MagicMock(return_value=[
    ...
    service._providers["groq"].generate.side_effect = RateLimitError("Rate limit reached. Please try again in 4.845s")
